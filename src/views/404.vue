<!--
  @Author: 戴伟
  @Date: 2023-05-25 15:31:30
 * @FilePath: \video_monitor_platform\src\views\404.vue
 * @LastEditTime: 2023-08-08 16:30:53
 * @LastEditors: 孙红日
  @Description: 
        do.....
-->
...
<template>
  <div class="ve_404" :class="{ isInMain: isInMainCOM }" ref="commonRef">
    ...
    <slot>
      <div class="error">
        ...
        <button class="error__button error__button--active" @click="goTo">
          回到首页
        </button>
...
const isInMainCOM = computed(() => {
  let _isInMain = false;
  if (commonRef?.value?.parentNode?.localName == "main") {
    _isInMain = true;
  }
...
// const authRoutes = computed(() => appStore.authRoutes);
...
.ve_404 {
  ...
  &.isInMain {
    ...
    margin: calc(-1 * var(--el-main-padding));
  }
}
.moon {
